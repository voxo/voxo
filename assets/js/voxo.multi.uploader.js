									  ...
									  '<div class="media-body" id="vmu_mediabody_'+nid+'">' + 
									    '<div class="media-heading">'+ 
									      ...
									      '<div class="form-group">' + 
										    '<label for="xxx" class="col-sm-2 control-label">Görsel Başlığı</label>' + 
										    '<div class="col-sm-10">' + 
									      ...
									      '<div class="form-group">' + 
										    '<label for="xxx" class="col-sm-2 control-label">Görsel İçeriği</label>' + 
										    '<div class="col-sm-10">' + 
									    ...
									    '<div class="form-group form-group-end">' + 
										    ...
										    '<div class="col-sm-10">'+
											    '<div class="progress active" id="progress'+ nid +'">' + 
